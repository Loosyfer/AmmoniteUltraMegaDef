...
public class MemInfo : ScriptableObject
{
    ...
    public string[] traitList = new string[236]
    {
        ...
        "War Fanatic", "Pacifist", "Tilter", "Thief", "Toxic", "Has an Imaginary Friend", "Flat Earther", "Unlucky", "Lucky", "Insecure", "Jealous", "Elitist", "He Shits Himself", "Nervous Flirter", "Geek", "Serial Killer", "Vain",
    ...
    public string[] tDescription = new string[236]
    {
        ...
        "+20% Performance to all adjacent Crew Members for 30 turns, after which all exposed Crew Members will instead have -20% Performance.",
        ...
        "This Trait won't show during recruitment, instead they will show another random Trait. At the start of the next Boss battle, their Trait will change to Traitor and they will proceed to sabotage the Dive by damaging random adjacent Crew Members for 1 Health every 2 turns, and Water-flooding an adjacent module every turn.", 
        "Only exists as a hidden secondary Trait. 15 turns after recruitment, the Undercover Competitor Trait will activate, and everything in the Shop will cost 50 coins more. Nonetheless, you won't know who has Undercover Competitor as their hidden secondary Trait.", 
        ...
        "30% Performance, but every time you defeat a different creature, +4% Performance.", "If your Ship is not top-bottom symmetrical, -20% Performance and after 10 turns will become Lunatic.", 
        ...
        "If their or an adjacent Module gets hit or explodes, they will deal 1 Health damage to an adjacent Crew Member, prioritising the one the disturbance came from.", 
    ...
    public int[] traitPrice = new int[236] { 100, 0, 50, 0, 50, 50, 50, 50, 50, 100,
                                              50, 0, 0, 0, 100, 50, 0, 100, 50, 0,
                                              0, 0, 50, 0, 0, 50, 0, 50, 0, 50,
                                              0, 100, 100, 0, 0, 0, 100, 0, 0, 100,
                                              50, 0, 50, 0, 50, 0, 0, 50 ,50, 50,
                                              0, 50, 50, 0, 0, 50, 100, 50, 0, 0,
                                              50, 50, 50, 50, 0, 0, 50, 0, 0, 50,
                                              0, 50, 50, 100, 0, 100, 100, 50, 100, 50,
                                              50, 50, 0, 50, 100, 50, 50, 0, 0, 100,
                                              50, 0, 50, 50, 0, 50, 100, 100, 50, 50,
                                              50, 50, 50, 50, 50, 50, 50, 50, 50, 50,
                                              0, 100, 100,0, 0, 50, 50, 50, 50, 50,
                                              50, 0, 0, 50, 0, 50, 0, 50, 50, 50,
                                              50, 100, 50, 50, 50, 50, 0, 50, 50, 50,
                                              100, 100, 100, 50, 0, 50, 50, 0, 50, 50,
                                              50, 50, 50, 100, 50, 100, 50, 50, 50, 100,
                                              0, 0, 100, 0, 50, 50, 50, 50, 50, 0,
                                              50, 50, 100, 100, 50, 50, 50, 100, 100, 100,
                                              0, 0, 50, 100, 100, 50, 100, 0, 100, 50,
                                              0, 100, 0, 0, 50, 50, 50, 0, 50, 50, 
                                              100, 50, 100, 50, 100, 50, 100, 0, 0, 50, 
                                              100, 50, 50, 0, 50, 100, 0, 0, 0, 50, 
                                              50, 100, 100, 50, 100, 100, 50, 50, 100, 50,
                                              0, 0, 0, 0, 0, 0};
    public int[] profPrice = new int[] { 200, 200, 200, 200, 200, 100, 200, 200, 200, 200, 200, 300 };
