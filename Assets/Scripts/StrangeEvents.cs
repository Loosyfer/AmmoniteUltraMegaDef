...
public class StrangeEvents : ScriptableObject
{
    ...
    public string[] uRareEventsDescription = new string[]
    {
        ...
        "Find a legendary age-lost golden treasure that contains 2000 coins.",
        ...
        "Ship that has traveled the seas for centuries. If you beat this vessel, receive 5 Ghost crew members.",
