...
"1000HP. 50dpt. Every attack from your ship has a 25% chance of getting blocked by his shield, and a 25% chance of being deflected and parried back onto your ship. It will hit the highest-performing crew members.",
...
"1000HP. 50dpt. Odd number attacks poison the target, while even number attacks hit 2 modules and each of them have a 50% chance of becoming damaged.",
...
"500HP. 50dpt. 400HP shell. Every time he’s attacked with shell, there’s a 40% chance he hides inside his shell and completely blocks the attack.",
"900HP. 70dpt. When below 500HP, goes berserk, breaking out of its cage, and throwing the metal bars at the ship, causing each module hit to become water-flooded, and dealing double damage to crew members.",
...
"1400HP. 70dpt. Every 6 turns, starting 1, grabs a random item from your ship and throws it away into the ocean and it's lost forever. Every 6 turns starting 4, attacks with the anchor causing the targeted module to become damaged.",
...
"800HP. 80dpt. Will prioritise the highest performing crew members.",
...
"2000HP. 100dpt. Every 4 turns, throws an electric beam that stuns 50% of crew members, while the other 50% have their trait randomly changed for this battle. If he’s regular attacks hits an item, he keeps it until he’s defeated.",
...
"1500HP. 100dpt. Every 6 turns, one random Crew Member close to Mystic Squid becomes a Centenarian forever. Every 6 turns starting 3, it swaps around 2 modules.",
...
"1200HP. 60dpt. After dying, it revives with full health and 120dpt, and throws the head at your ship, exploding the module hit and inflicting Sick to adjacent crew members. Heals 50HP for every crew member that dies.",
...
"2000HP. 100dpt. Every crew member hit will forget their profession for the rest of the fight. Every 6 turns, throws a spell that causes 4 modules to be set on fire, frozen of become wild.",
