...
{
    public string[] names = new string[15] { "Visceral Execution", "Submabomber", "Soul Crusher", "Body Splicer", "Cryogenic Lab", "Absolute Assembly", "Flesh Buffer", "Duplex Ship", "Destiny Portal",
    "Megabrain Core", "Clone Lab", "Colossal Expansion", "Cathedral of the Depths", "Extreme Hospital", "Steel Sacrificer"};

    public string[] moduleDetails = new string[15] {"If a creature has less than 500HP, you can execute it, but will be utterly disintegrated and you won’t be able to harvest it for any organic effects or modules. Charges up after 5 battles. If operated by a General Officer, it can be executed at 700 HP.",
...
"If a crew member dies in or adjacent to this mega module, they return as a Zombie.",
"If your ship is below 30% HP, a random adjacent module will be destroyed for every attack over 100 HP you were about to receive."};

    public int[] cooldown = new int[15] { 50, 0, 0, 50, 50, 0, 0, 0, 0, 40, 15, 0, 40, 0, 0 };


    public ModuleType[] moduleType = new ModuleType[15] { (ModuleType)1, (ModuleType)1, (ModuleType)1, (ModuleType)3, (ModuleType)3, (ModuleType)4, (ModuleType)2, (ModuleType)3, (ModuleType)4, (ModuleType)3,
    (ModuleType)3, (ModuleType)2, (ModuleType)4, (ModuleType)3, (ModuleType)2 };

    public string[] req = new string[15] { "0", "0", "0", "0", "0", "Can only be manned by an Architect", "0", "Must have 8x Engineers, and can only be manned by one", "Can only be used once, during an Abyssal Beast battle",
        "Can only be manned by a Developer", "Adjacent to a scientist", "0", "Only works when manned and adjacent to another 6 crew members", "Requires a Doctor or Scientist in it", "0"};
