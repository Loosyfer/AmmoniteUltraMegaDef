...
public enum ProfessionType { Architect, Psychologist, Biologist, Developer, Engineer, Cadet, Doctor, CEO, Businessman, Scientist, Explorer, War_General, Inventor, Wizard };
